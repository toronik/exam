...
- https://github.com/Adven27/Exam/tree/master/exam-mq-kafka[exam-mq-kafka]
- https://github.com/Adven27/Exam/tree/master/exam-mq-rabbit[exam-mq-rabbit]
- https://github.com/Adven27/Exam/tree/master/exam-mq-ibmmq[exam-mq-ibmmq]
- https://github.com/Adven27/Exam/tree/master/exam-mq-redis[exam-mq-redis]
...
_Queue alias_ is a queue logical name: `<e e:mq-set="out"/>`
